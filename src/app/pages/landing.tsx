...
export default function LandingPage() {
  ...
  const features = [
    {
      icon: <Network className="w-8 h-8 text-[#00FF41]" />,
    ...
    {
      icon: <Target className="w-8 h-8 text-[#00FF41]" />,
  ...
  return (
    <div className="min-h-screen bg-[#0F172A]">
      {/* Header */}
      <header className="border-b border-[#334155] bg-[#0F172A]/95 backdrop-blur supports-[backdrop-filter]:bg-[#0F172A]/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link to="/" className="text-sm text-[#94A3B8] hover:text-[#00FF41] transition-colors">Home</Link>
            <Link to="/pricing" className="text-sm text-[#94A3B8] hover:text-[#00FF41] transition-colors">Pricing</Link>
            {isAuthenticated ? (
              <Link to="/dashboard" className="text-sm text-[#94A3B8] hover:text-[#00FF41] transition-colors">Dashboard</Link>
            ) : (
              <Link to="/auth" className="text-sm text-[#94A3B8] hover:text-[#00FF41] transition-colors">Sign In</Link>
            )}
          </nav>
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <Badge className="bg-[#1E293B] text-[#00FF41] border-[#334155] font-mono">
            v1.0.0 - Now in Beta
          </Badge>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            Master Enterprise Networking <br />
            <span className="text-[#00FF41]">in a Virtual Lab</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-[#334155] hover:bg-[#1E293B]">
              View Documentation
            </Button>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <Card key={i} className="bg-[#1E293B] border-[#334155] hover:border-[#3B82F6] transition-colors">
              <CardHeader>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-[#94A3B8] text-lg">Get started in three simple steps</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, i) => (
            <div key={i} className="relative">
              <div className="text-center space-y-4">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#1E293B] border-2 border-[#3B82F6]">
                  <span className="text-2xl font-mono text-[#3B82F6]">{step.number}</span>
                </div>
                <h3 className="text-xl font-semibold">{step.title}</h3>
                <p className="text-[#94A3B8]">{step.description}</p>
              </div>
              {i < steps.length - 1 && (
                <div className="hidden md:block absolute top-8 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-0.5 bg-[#334155]" />
              )}
            </div>
          ))}
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-[#94A3B8] text-lg">Meet the engineers behind Smart IT Lab</p>
        </div>
          ...
          {team.map((member, i) => (
            <Card key={i} className="bg-[#1E293B] border-[#334155] hover:border-[#3B82F6] transition-colors">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-sm text-[#94A3B8] font-mono">{member.role}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        <Card className="bg-[#1E293B] border-[#00FF41] max-w-md mx-auto">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-sm text-[#00FF41] font-mono">{supervisor.role}</p>
          </CardContent>
        </Card>
      </section>
      ...
      <footer className="border-t border-[#334155] bg-[#0F172A] mt-16">
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#94A3B8]">
                <li><Link to="/pricing" className="hover:text-[#00FF41] transition-colors">Pricing</Link></li>
                <li><Link to="/dashboard" className="hover:text-[#00FF41] transition-colors">Dashboard</Link></li>
                <li><a href="#" className="hover:text-[#00FF41] transition-colors">Labs</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#94A3B8]">
                ...
                <li><a href="#" className="hover:text-[#00FF41] transition-colors">Tutorials</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-[#334155] flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-[#94A3B8]">© 2026 Smart IT Lab. All rights reserved.</p>
            <div className="flex gap-4 mt-4 md:mt-0">
              <a href="#" className="text-[#94A3B8] hover:text-[#00FF41] transition-colors">
